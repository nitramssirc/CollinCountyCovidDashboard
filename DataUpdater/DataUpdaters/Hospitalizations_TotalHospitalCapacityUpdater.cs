...
{
    public class Hospitalizations_TotalHospitalCapacityUpdater : TexasStateExcelDataUpdater, IDataUpdater
    {
        ...
        protected override string LocalDataName => "CombinedHospitalDataoverTimebyTSARegion_TotalHospitalCapacity";

        protected override string LocalStateDataName => "CombinedHospitalDataoverTimebyTSARegion";

        protected override int texasDataTableIndex => 2;
