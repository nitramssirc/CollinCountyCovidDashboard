...
{
    public class Hospitalizations_TotalOccupiedBedsUpdater : TexasStateExcelDataUpdater, IDataUpdater
    {
        ...
        protected override string LocalDataName => "CombinedHospitalDataoverTimebyTSARegion_TotalOccupiedBeds";

        protected override string LocalStateDataName => "CombinedHospitalDataoverTimebyTSARegion";

        protected override int texasDataTableIndex => 9;
