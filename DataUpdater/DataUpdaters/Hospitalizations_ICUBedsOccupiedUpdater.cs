...
{
    public class Hospitalizations_ICUBedsOccupiedUpdater : TexasStateExcelDataUpdater, IDataUpdater
    {
        ...
        protected override string LocalDataName => "CombinedHospitalDataoverTimebyTSARegion_ICUBedsOccupied";

        protected override string LocalStateDataName => "CombinedHospitalDataoverTimebyTSARegion";

        protected override int texasDataTableIndex => 10;
